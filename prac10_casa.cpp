/*Semestre 2019 - 2
	...
	VISUAL STUDIO 2017
	PRACTICA 10 (casa)
		SE MUESTRA UN HELICOPTERO CON SUS HELICES QUE GIRAN		
*/
...
//Figuras de 3D Studio   //PARA PODER CARGAR MODELOS EXTERNOS
CModel kit;
CModel llanta;
...
void InitGL(GLvoid)     // Inicializamos parametros
{
	...
	//Carga de Figuras
	kit._3dsLoad("uh60.3ds"); //MANDAR A LLAMAR MODELO 3D	
	//kit.VertexNormals(); 

	llanta._3dsLoad("ceiling fan.3ds");
	...
	glPushMatrix();
		...
		glPushMatrix();
			...
			glPushMatrix();
				...
				glTranslatef(0, 4, movKit); //ANIMACION DEL HELICOPTERO
				//Pongo aquí la carcasa del helicoptero
...
void animacion()
{
	...
	//SE APLICA LA REVERSA
	if (g_fanimacion == false && reversa == true)
	{
		if (movKit <= -65)
			g_fanimacion = true;
